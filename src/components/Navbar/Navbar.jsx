  ...
  return (
    <div className='navbar'>
        ...
        <ul className='nav-menu'>
            ...
            <li onClick={()=>setMenu('mens')}> <Link style={{textDecoration:'none',color:'#000'}} to='/mens'>Men</Link>  {menu==='mens'?<hr/>:<></>}</li>
            <li onClick={()=>setMenu('womens')}> <Link style={{textDecoration:'none',color:'#000'}} to='/womens'>Women</Link>  {menu==='womens'?<hr/>:<></>}</li>
